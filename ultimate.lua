...
Ultimate Intervalometer v4.4

Licence: GPL (c) 2013, 2014, 2015, 2016 waterwingz
...
--[[ ========================== Main Program ========================================================================= --]]
    ...
    printf("=== Ultimate v4.4 : %02d:%02d ===", now/3600, now%3600/60)
    bi=get_buildinfo()
                            ...
                            for i = 0-hdr_shots, hdr_shots, 1 do
                                if (i ~= 0 ) then
                                    if (hdr_mode == 1) then
                                        ...
                                        set_tv96(tv96current+tv_offset*i)
                                        set_av96(av96current+av_offset*i)
